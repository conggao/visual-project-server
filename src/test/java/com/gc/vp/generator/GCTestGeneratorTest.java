...
public class GCTestGeneratorTest {
    private final String url = "jdbc:mysql://39.108.124.26:3306/visual-proj?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8";
...
//                            .moduleName("system") // 设置父包模块名
                ...
                .strategyConfig(builder -> {
                    builder
                            ...
                            .addInclude("vp_code_category", "vp_code_segment")
                            .addTablePrefix("vp_")
                            // 设置控制器
                            .controllerBuilder()
                            .enableRestStyle()
